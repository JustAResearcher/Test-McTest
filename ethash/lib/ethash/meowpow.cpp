...
inline uint32_t random_math(uint32_t a, uint32_t b, uint32_t selector) noexcept
{
    ...
    case 11:
        return byte_perm(a, b, selector >> 16);  // Maps to CUDA __byte_perm
    case 12:
        return brev32(a) ^ b;                    // Maps to CUDA __brev
    case 13:
        return funnelshift_l(a, b, selector);    // Maps to CUDA __funnelshift_l
    case 14:
        return mad_lo32(a, b, selector >> 16);   // Maps to GPU MAD unit
    }
}
...
inline void random_merge(uint32_t& a, uint32_t b, uint32_t selector) noexcept
{
    ...
    case 3:
        ...
        break;
    case 4:
        a = (a + b) ^ rotl32(b, x);   // Add-rotate-xor
        break;
    case 5:
        a = mul_hi32(a, b) ^ b;       // Hi-multiply-xor
        break;
    }
}
...
static const uint32_t meowcoin_kawpow[15] = {
        0x00000054, //T
        0x00000041, //A
        0x00000052, //R
        0x00000049, //I
